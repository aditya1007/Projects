...
float const threehalfpi=3.0f*DP_PI/2.0f;  		// pi times 3/2, used in tan routines
float const four_over_pi=4.0f/DP_PI;		// 4/pi, used in tan routines
float const qtrpi=DP_PI/4.0f;			// pi/4.0, used in tan routines
float const sixthpi=DP_PI/6.0f;			// pi/6.0, used in atan routines
float const tansixthpi=0.577350269189626f;		// tan(pi/6), used in atan routines
float const twelfthpi=DP_PI/12.0f;			// pi/12.0, used in atan routines
float const tantwelfthpi=0.267949192431123f;	// tan(pi/12), used in atan routines
